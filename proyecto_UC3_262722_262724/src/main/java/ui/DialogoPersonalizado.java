 ...
 * textual detallada (como secuencias de algoritmos o reportes) manteniendo la
 * línea estática del sistema.
 *
...
public class DialogoPersonalizado extends JDialog {
    ...
    /**
     * Constructor que construye e inicializa el diálogo con un estilo azul
     * marino.
     *
     * @param padre Ventana principal (Frame) sobre la cual se posicionará el
     * diálogo.
     * @param titulo Texto que aparecerá en el encabezado de la ventana.
     * @param contenido Texto descriptivo o secuencia que se mostrará en el área
     * central.
     */
